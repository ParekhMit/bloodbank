...
urlpatterns = [
    ...
    path('testthalasemia/', testthalasemia, name="testthalasemia"),
    path('historyprediction/', historyprediction, name="historyprediction"),
    path('deletetest/<int:pid>/', deletetest, name="deletetest"),
    path('adminlistthalasemia/', adminlistthalasemia, name="adminlistthalasemia"),
